...
import './PortfolioUsuarioAzul.css';

function PortfolioUsuarioAzul() {
...
<div className='FundoRosa'>
  <img src="public/images/fundoazul.png" alt="" />  
      ...
      <div className="Header-InformacoesAzul">
        ...
        <div className="Header2-InformacoesAzul">
          ...
          <div className="botoes">
            ...
            <button className="Button-ContratarUsuarioAzul">contrate</button>
          </div>
      ...
      <div className="Container-Avaliacoes">
        ...
        <p className='DeixarAvaliacaoAzul'>Deseja deixar uma avaliação?</p>
        <button className='CliqueiAquiAzul' onClick={() => setMenuComentarioAtivo(true)}>CliqueiAqui</button>
        <div className="CarrosselComentariosAzul-Container">

          <div className="Comentarios-Container">
          <div className="comentarios" ref={comentariosRef}>
              {comentarios.map((comentario, index) => (
                <div key={index} className="Comentarioazul">
                  <p>{comentario}</p>
                </div>
              ))}
            </div>
...
export default PortfolioUsuarioAzul;